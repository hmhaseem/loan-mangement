    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.accounts.update',$account->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input class="form-control {{ $errors->has('payment_amount') ? 'is-invalid' : '' }}" type="number"
                            name="payment_amount" id="payment_amount" value="{{ old('payment_amount', $account->payment_amount) }}" required
                            maxlength="20">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text"
                            name="remarks" id="remarks" value="{{ old('remarks', $account->remarks) }}" required maxlength="200">
                ...
                <button class="btn btn-primary mt-10" type="submit"> Update the payment to account</button>
            </form>
        </div>
